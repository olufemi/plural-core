...
public class InvestmentProductService {
    ...
    private InvestmentProductRecord toRecord(InvestmentProduct product) {
        ...
        record.setMetaJson(product.getMetaJson());
        ...
        record.setScheduleMode(product.getScheduleMode() != null ? product.getScheduleMode().name() : null);
        record.setInterestAccrueType(product.getInterestAccrueType() != null ? product.getInterestAccrueType().name() : null);
        record.setInterestCapitalization(product.getInterestCapitalization() != null ? product.getInterestCapitalization().name() : null);
        record.setSettlementDelayMinutes(product.getSettlementDelayMinutes());
        record.setTenorDays(product.getTenorDays());
        record.setTenorMinutes(product.getTenorMinutes());
        record.setSettlementAt(product.getSettlementAt());
        record.setMaturityAt(product.getMaturityAt());
        record.setSubscriptionCutOffTime(product.getSubscriptionCutOffTime());
