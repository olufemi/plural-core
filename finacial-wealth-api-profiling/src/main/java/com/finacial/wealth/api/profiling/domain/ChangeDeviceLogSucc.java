...
@Entity
@Data
public class ChangeDeviceLogSucc implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final String SEQ_NAME = "CHG_DEVICE_LOG_SUCC_SEQ";
    @Id
    ...
    @Column(name = "NEW_UUID")
    private String newUuid;

    @Column(name = "EXISTING_UUID")
