...
@Entity
@Data
public class CreateVirtualAcctSucc implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final String SEQ_NAME = "CreateVirtualAcctSucc_SEQ";
    @Id
    ...
    private String webHookResponseDesc;
    

    @Column(name = "eamilAddress")
    private String email;

    @Lob
    @Column(name = "PAY_LOAD", length = 100000)
