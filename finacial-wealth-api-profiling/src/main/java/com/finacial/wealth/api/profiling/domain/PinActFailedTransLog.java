...
@Data
@NoArgsConstructor
public class PinActFailedTransLog implements Serializable {
    ...
    public PinActFailedTransLog(String ActionType, String ActionTypeDesc, String TransactionId, String RegChannel,
            String PhoneNumber
    ) {
