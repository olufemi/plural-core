 ...
 */
@Entity
@Table(name = "KUL_PAYMENT_TRANS_REPORT")
@Data
public class FinWealthPaymentTransReport implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final String SEQ_NAME = "KUL_PAYMENT_TRANS_REPORT_SEQ";
    @Id
    ...
    private BigDecimal feesCummulative;
    private BigDecimal cusFeesCummulative;
    private String transactionId;
    private String sentAmount;
    private BigDecimal sentAmountCum;
    private BigDecimal payTypeSentAmountCum;
    //private BigDecimal cusPayTypeSentAmtCum;
    private BigDecimal cusSentAmountCum;
    private int countPayTypeTrans;
    private int countCusPayTypeTrans;
