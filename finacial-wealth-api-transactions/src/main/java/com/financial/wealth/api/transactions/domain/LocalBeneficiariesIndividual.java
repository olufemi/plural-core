...
@Entity
@Data
@Table(name = "LOCAL_T_B_FIC_INDIVIDUAL")
public class LocalBeneficiariesIndividual implements Serializable {

    private static final String SEQ_NAME = "LOCAL_T_B_FIC_INDIVIDUAL_SEQ";
