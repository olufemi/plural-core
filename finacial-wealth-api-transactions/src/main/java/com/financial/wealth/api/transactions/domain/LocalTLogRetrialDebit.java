...
@Entity
@Data
public class LocalTLogRetrialDebit implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final String SEQ_NAME = "LocalTLogRetrialDebit_SEQ";
    @Id
    ...
    private String kuleanFees;
    private String narration;
    private String processedStatus;
     private String processedStatusDesc;
