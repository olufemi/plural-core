...
@Data
@NoArgsConstructor
public class LocalTransFailedTransInfo implements Serializable {
    ...
    public LocalTransFailedTransInfo(String actionType, String actionTypeDesc, String transactionId, String userId, String channel, String source
    ) {
