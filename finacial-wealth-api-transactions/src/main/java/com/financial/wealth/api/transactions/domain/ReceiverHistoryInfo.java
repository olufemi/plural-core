...
@Data
@NoArgsConstructor
public class ReceiverHistoryInfo implements Serializable {
    ...
    public ReceiverHistoryInfo(String ActionType, String ActionTypeDesc, String TransactionId, String RegPoint, String RegPointCallerId,
            String PhoneNumber) {
