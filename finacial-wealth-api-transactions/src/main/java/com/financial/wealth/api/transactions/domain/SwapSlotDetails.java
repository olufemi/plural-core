...
import com.financial.wealth.api.transactions.models.*;
 ...
 */
@Entity
@Table(name = "GROUP_SAV_SWAP_SLOT_DETAILS")
@Data
public class SwapSlotDetails implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final String SEQ_NAME = "GROUP_SAV_SWAP_SLOT_DETAILS_SEQ";
    @Id
