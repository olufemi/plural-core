...
public class MessageCenterService {
    ...
    /** Broadcast by iterating users or (preferable) via topics; still store a row per user */
    @Transactional
    ...
    private static Long ts(Date d) { return d == null ? null : d.getTime(); }

    @SuppressWarnings("unchecked")
    private Map<String,Object> parseOrEmpty(String json) {
        try { return json == null ? new HashMap<>() : new ObjectMapper().readValue(json, Map.class); }
