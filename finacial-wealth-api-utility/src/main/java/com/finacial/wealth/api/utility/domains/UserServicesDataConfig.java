 ...
 */
@Entity
@Table(name = "SERVICES_DATA_CONFIG")
@Data
public class UserServicesDataConfig implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final String SEQ_NAME = "SERVICES_DATA_CONFIG_SEQ";
    @Id
