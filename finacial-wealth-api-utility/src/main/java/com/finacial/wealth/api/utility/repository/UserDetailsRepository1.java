 ...
 * @author OSHIN
 */
public interface UserDetailsRepository1 extends
    ...
    Optional<UserDetails> findByUserId(@Param("uniqueIdentification") String uniqueIdentification);
    ...
    @Query("SELECT u FROM UserDetails u where u.uniqueIdentification = :uniqueIdentification")
    UserDetails findByUniqueIdentification(@Param("uniqueIdentification") String uniqueIdentification);
    ...
    public String findUserGroupId(@Param("uniqueIdentification") String uniqueIdentification);
