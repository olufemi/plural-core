...
public class BoInvestmentController {
  ...
  private List<Map<String, Object>> extractItems(Map<String, Object> data) {
    ...
    if (d instanceof Map<?, ?> m) {
      ...
      if (items instanceof List<?> l) return (List<Map<String, Object>>) l;
      Object items2 = m.get("data");
      if (items2 instanceof List<?> l2) return (List<Map<String, Object>>) l2;
    }
    Object items3 = data.get("items");
    if (items3 instanceof List<?> l3) return (List<Map<String, Object>>) l3;
